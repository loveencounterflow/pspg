...
(function() {
  'use strict';
  var $, $async, CND, PATH, PS, PSPG, abspath, badge, debug, declare, echo, help, info, isa, join_paths, jr, path_1, rpr, select, size_of, to_width, type_of, types, urge, validate, warn, whisper, width_of,
  ...
  this.demo_many_rows = function() {
    return new Promise((resolve) => {
      var pipeline, source;
      source = PS.new_value_source(this.get_random_words(1e3));
      pipeline = [];
      pipeline.push(source);
  ...
  if (module.parent == null) {
    (async() => {
      await this.demo_many_rows();
      await this.demo_tabular_output();
      await this.demo_tabular_output_with_different_shapes();
      return (await this.demo_paged_output());
    })();
  }

...
(function() {
  'use strict';
  var $, $async, CND, PATH, PS, abspath, badge, debug, echo, help, info, join_paths, rpr, select, to_width, urge, warn, whisper, width_of;
...
/* data */
  ...
  (function() {
    ...
    */
    var end_output, new_pager, output, pager_settings, pipeline, pull_stream_to_stream, source, stream;
    ...
    stream.pipe(new_pager(pager_settings, function() {
      return urge('ok');
    }));
    output = function(t) {

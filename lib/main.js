(function() {
  'use strict';
  var $, $async, CND, PATH, SP, abspath, assign, badge, debug, declare, echo, help, info, isa, join_paths, jr, new_pager, path_to_pspg, rpr, select, size_of, to_width, type_of, types, urge, validate, warn, whisper, width_of;
  ...
  this.$page_output = function(settings, handler) {
    ...
    last = Symbol('last');
    //.........................................................................................................
    return SP.$watch({last}, function(line) {
      if (line === last) {
        return source.end();
      }
      if (line == null) {
